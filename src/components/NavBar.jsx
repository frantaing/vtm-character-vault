...
function NavBar() {
  ...
  return(
    <nav className="flex flex-col gap-5">
      <section>
        <div className="flex justify-between items-center pl-5 pr-2 py-2 bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors">
          {/* Logo + Title */}
          ...
          {/* <input type="text" placeholder="Search?" className="w-24 px-5 py-2 text-black text-xs text-right rounded-lg transition hover:bg-gray-200 focus:outline-0" /> */}
      
          <div className="flex px-3">
            {/* Link to repo */}
            <a href='https://github.com/frantaing/vtm-character-vault' className='group flex gap-2 items-center px-3 py-1 bg-transparent rounded-lg transition hover:bg-gray-200 dark:hover:bg-gray-700'>
            ...
            <button 
              onClick={toggleTheme}
              className="group px-1 py-1 rounded-lg cursor-pointer transition hover:bg-black dark:hover:bg-white"
