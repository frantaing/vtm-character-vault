...
function NavBar() {
  ...
  return(
    <nav className="flex flex-col gap-5">
      <section>
        <div className="flex justify-between items-center pl-5 pr-2 py-1 bg-gray-100 dark:bg-gray-800 rounded-full transition-colors">
          {/* Logo + Title */}
          ...
          <div className="flex px-3">
            {/* Link to repo */}
            <a href='https://github.com/frantaing/vtm-character-vault' className='group flex gap-2 items-center pl-3 pr-2 py-1 pt-1.5 bg-transparent rounded-full transition hover:bg-gray-200 dark:hover:bg-gray-700'>
            ...
            <button 
              onClick={toggleTheme}
              className="group px-1.5 py-1 rounded-full cursor-pointer transition hover:bg-black dark:hover:bg-white"
