...
function PageLink({ to, children }) {
    ...
    const PageLinkStyles = "block text-sm! cursor-pointer px-5 py-2 text-text-secondary dark:text-text-secondary-dark bg-bg-secondary dark:bg-bg-secondary-dark rounded-lg transition-all hover:italic hover:italic hover:text-text-primary dark:hover:text-text-primary-dark hover:bg-bg-tertiary dark:hover:bg-bg-tertiary-dark sm:text-base";
